...
If you have an issue with the Snap or Flatpak version of LosslessCut, try instead the GitHub [downloads](https://github.com/mifi/lossless-cut/releases/latest). I **cannot provide support for the [Flatpak version](https://github.com/flathub/no.mifi.losslesscut)** because is not maintained by me.
